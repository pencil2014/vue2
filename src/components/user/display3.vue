<template>
	<div class="ex-addgoods">
		...
		<div class="modal_BJ" v-show="showClassifyModel">
			<div class="modal">
				<div class="modal_box">
					...
					<div class="field">
						<ul>
							<li v-for='item in classifyList'>
								...
								<span class="checkboxGroup">
		          		<input type="radio" :value="item.id" :id='item.id' v-model="classifyId" @change='chageClassify(item)'>
