...
<style scoped>
.ex-model{position: fixed;top: 0;right: 0;bottom: 0;left: 0;z-index: 2;}
...
.ex-model-title{ height: 3rem; line-height: 3rem; text-align: center; font-size: 1.8rem; padding:1.5rem 0 1rem;}
.ex-model-body {line-height: 1.5;font-size: 1.4rem; padding: 0 2rem; padding-bottom: 0.5rem;}
