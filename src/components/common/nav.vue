<template>
	<div class="ex-nav">
		<router-link to="/index" :class="{activeRouter: isBuesiness}"><i class="iconfont m1">&#xe607;</i>我的</router-link>
		<router-link to="/login"><i class="iconfont m2">&#xe619;</i>联盟商家</router-link>
		<router-link to="/register"><i class="iconfont m3">&#xe60a;</i>商学院</router-link>
		<router-link to="/message"><i class="iconfont m4">&#xe670;</i>公告</router-link>
	</div>
</template>
...
.ex-nav a {display: inline-block; width: 24%; text-align: center; color: #aaa;padding-bottom: 0.5rem;}
