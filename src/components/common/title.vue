<template>
	<div class="ex-header" :class="{fixed:title.fixed}">
...
<style scoped>
.ex-header{height: 4.5rem; background-color: rgb(255,255,255);color: rgb( 33,42,50); text-align: center;position: relative;display: block; line-height: 4.5rem;box-shadow:1px 1px 0px #ebebeb;z-index: 10001;}
