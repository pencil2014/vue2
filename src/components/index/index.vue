	...
	data () {
        ...
        twoPwd: ''
		  ...
		  model: {
		  	title: '温馨提示',
		  	text: 
		  	'<b>尊敬的e享时代用户：</b><p>为了符合数据规范化透明化，现把昨日交易总额更改为显示历史应分享单元值。参数为历史剩下的分享单元总额。请刷新页面自动更新！</p><p>感谢您对e享时代的支持与信任！如有任何疑问，敬请致电客服:<a href="tel:4006543888">4006543888</a>,<a href="tel:075523300320">0755-23300320</a></p><div class="inscribe"><p>深圳易享时代运营服务有限公司</p><p>二〇一七年六月二日</p></div>',
		  	confirm: '知道了',
