<template>
	<div class="ex-school">
		...
		<b>1、入会原则。</b>
		<p>实行“入会自愿，退会自由；交费升级，会费不退”的原则。</p>
		<b>2、免费申请会员。</b>
		<p>不论是商家还是消费者，只要认可并网签《会员服务协议》，均可经会员推荐或通过公司注册登录页面申请成为e享时代普通会员。</p>
		<b>3、升级VIP会员。</b>
		<p>普通会员一次性交付998元会费即升级为VIP会员，同时获得会费等额e积分。VIP会员如果退会，其所交会费不予退回。</p>
		<b>4、会员的权利与相关福利：</b>
		<p>（1）推荐会员。</p>
		...
		<p>（4）随时将享积分兑现为平台资金。</p>
		<p>（5）随时将平台资金转存银行。</p>
		<p>（6）获得推荐会员消费的福利收益和推荐会员升级VIP会员的福利收益。VIP会员的消费推荐福利收益是普通会员的十倍，即5%的e积分福利收益，可享受一代的消费推荐福利收益。不论是普通会员还是VIP会员，每推荐一名会员升级为VIP会员，均可获得180元现金的推荐福利收益。普通会员还能获得其推荐会员升级VIP时所得e积分0.5%的推荐福利收益，VIP会员获得的推荐福利收益是普通会员十倍即5%的e积分。</p>
...
.ex-word-cnt b {font-size: 1.4rem; margin: 0.5rem 0; display: block;}
